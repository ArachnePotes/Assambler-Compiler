import argparse
import sly
from mega_lexer import MegaLexer
from mega_ast import *
import graphviz as gpv


class MegaParser(sly.Parser):
    debugfile = "mega_debug.txt"

    tokens = MegaLexer.tokens
...
class RenderAST(Visitor):
    ...
    def __init__(self):
        self.dot = gpv.Digraph(
            'Mega AST', comment='Agradecimientos a todos los compañeros del curso, sobre todo a mis amigos')
        self.dot.attr(
            label=r'\n\nMega Arbol de Sintaxis\nPor Juan Alejandro Pérez Bermúdez\n&\nMeme Squad')
